...
class ElementsPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.middle_field = WebElement(driver, '#app > div > div > div.row > div.col-12.mt-4.col-md-6')
        self.main_header = WebElement(driver, 'div.main-header')
        self.btn_sidebar_elements = WebElement(driver, 'div > div:nth-child(1) > span > div > div.header-text')
